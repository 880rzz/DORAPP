...
for o in db["organizations"]:
    ...
    src_html="<ul class=\"source-list\">"+"".join(f'<li><a href="{esc(u)}" target="_blank" rel="noopener external">{esc(u)}</a></li>' for u in src)+"</ul>" if src else "<p>Még nincs igazolt elsődleges eseményforrás rögzítve.</p>"
