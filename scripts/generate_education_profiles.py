...
for x in ed.get("institutions",[]):
    ...
    schema={"@context":"https://schema.org","@graph":[
      {"@type":"ProfilePage","name":x["name"]+" | Magyar oktatás Ausztriában","inLanguage":"hu-AT","mainEntity":{"@id":"#education"}},
